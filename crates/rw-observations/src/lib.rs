...
/// Default observation-grid limit. This is the shared address-space-derived
/// structural maximum, not a product-resolution or operational ceiling.
pub const DEFAULT_MAXIMUM_GRID_CELLS: usize = rustwx_core::MAX_GRID_CELLS;
