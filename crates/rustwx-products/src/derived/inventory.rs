...
const SUPPORTED_DERIVED_RECIPE_INVENTORY: &[DerivedRecipeInventoryEntry] = &[
    ...
    DerivedRecipeInventoryEntry {
        slug: "sbecape",
        title: "SB Analytic ECAPE",
        experimental: false,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "mlecape",
        title: "ML Analytic ECAPE",
        experimental: false,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "muecape",
        title: "MU Analytic ECAPE",
        experimental: false,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "sb_ecape_derived_cape_ratio",
        title: "SB Analytic ECAPE / Entraining Parcel CAPE Ratio (EXP)",
        experimental: true,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "ml_ecape_derived_cape_ratio",
        title: "ML Analytic ECAPE / Entraining Parcel CAPE Ratio (EXP)",
        experimental: true,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "mu_ecape_derived_cape_ratio",
        title: "MU Analytic ECAPE / Entraining Parcel CAPE Ratio (EXP)",
        experimental: true,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "sb_ecape_native_cape_ratio",
        title: "SB Analytic ECAPE / Native CAPE Ratio (EXP)",
        experimental: true,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "ml_ecape_native_cape_ratio",
        title: "ML Analytic ECAPE / Native CAPE Ratio (EXP)",
        experimental: true,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "mu_ecape_native_cape_ratio",
        title: "MU Analytic ECAPE / Native CAPE Ratio (EXP)",
        experimental: true,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "sbncape",
        title: "SBNCAPE (Analytic)",
        experimental: false,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "sbecin",
        title: "SB Entraining Parcel CIN",
        experimental: false,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "mlecin",
        title: "ML Entraining Parcel CIN",
        experimental: false,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "ecape_scp",
        title: "Analytic ECAPE SCP (EXP)",
        experimental: true,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "ecape_ehi_0_1km",
        title: "Analytic ECAPE EHI 0-1 km (EXP)",
        experimental: true,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "ecape_ehi_0_3km",
        title: "Analytic ECAPE EHI 0-3 km (EXP)",
        experimental: true,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
        slug: "ecape_stp",
        title: "Analytic ECAPE STP (EXP)",
        experimental: true,
        heavy: true,
    },
    DerivedRecipeInventoryEntry {
